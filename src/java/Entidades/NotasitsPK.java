 ...
 */
@Embeddable
public class NotasitsPK implements Serializable {
    ...
    public NotasitsPK(int instructor, int materia, int alumno, int semHabiNum, int semHabiAnho, int grupo, int carrera, int semestre) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NotasitsPK)) {
            return false;
        }
        NotasitsPK other = (NotasitsPK) object;
    ...
    public String toString() {
        return "Entidades.NotasitsPK[ instructor=" + instructor + ", materia=" + materia + ", alumno=" + alumno + ", semHabiNum=" + semHabiNum + ", semHabiAnho=" + semHabiAnho + ", grupo=" + grupo + ", carrera=" + carrera + ", semestre=" + semestre + " ]";
    }
